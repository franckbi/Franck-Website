        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Interactive 3D portfolio showcasing projects, skills, and
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <Link
                href="/contact"
                className="text-primary hover:text-primary/80 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-sm"
              >
                Get in touch →
              </Link>
            </div>
